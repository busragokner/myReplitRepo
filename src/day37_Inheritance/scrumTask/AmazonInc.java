...
public class AmazonInc {
    public static void main(String[] args) {
        ...
        Tester tester1 = new Tester("Chiara", 32, 'F',"QA" , 1415, 125000, company);

        Tester tester2 = new Tester("Yasaman", 31, 'F', "QA",1416,130000,company );

        Tester tester3 = new Tester("Irena",29, 'F', "QA",1417, 125000,company);

        Tester tester4 = new Tester("Cihad", 26, 'M', "QA", 1418, 130000,company);

        Tester[] testers = {tester1, tester2,tester3,tester4};

        Developer developer1 = new Developer("Daniel", 27, 'F', "Java Developer", 8, 135000,company);
