...
public class LogicalOperators {
    public static void main(String[] args) {
        ...
        //! =logical no
        boolean isEligible1 = age >= 18 && citizen=="USA";
        ...
        int age2 = 17;
        int income= 40000;
        boolean isEligible3 = creditScore >= 700 && age2>= 21 && income >= 60000;
        System.out.println( name2 + " is eligible for loan: " + isEligible3);
        ...
        int age3 = 21;
        char gender = 'F';
        boolean isEligible4 = age3 >= 18 && (gender =='M'|| gender == 'F');
        ...
        System.out.println( name4 + " is eligible to apply for US citizen: "+ isEligible5);
        System.out.println("-----------------------------------------------------------------");
